...
public class Java_Console_Hr_Application {
	...
	public static void main(String[] args) {
		...
		if (qualification.equalsIgnoreCase("Degree") ||qualification.equalsIgnoreCase("B.TECH") || qualification.equalsIgnoreCase("M.TECH")) {
			...
			if (Arrays.asList(skills).contains("Java") && Arrays.asList(skills).contains("React")
				...
				if (experience >= 0 && experience <= 4) {
					...
					String loc = sc.next();
					if (loc.equalsIgnoreCase("Bangalore") || loc.equalsIgnoreCase("Hyderabad")) {
